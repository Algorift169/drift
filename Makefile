...
SRCS = main.c token/token.c lexer/core/lexer.c lexer/keywords/logical_keywords.c lexer/keywords/identity_keywords.c lexer/comments/comments.c lexer/comments/executable_comments.c parser/core/parser.c parser/control_flow/if_parser.c parser/control_flow/repeat_parser.c parser/control_flow/for_parser.c parser/control_flow/while_parser.c parser/arrays/array_parser.c parser/arrays/select_parser.c interpreter/core/value.c interpreter/core/environment.c interpreter/core/input.c interpreter/core/intptr.c interpreter/loop/repeat.c interpreter/loop/for.c interpreter/loop/while.c interpreter/arrays/array_value.c interpreter/arrays/array.c interpreter/operators/operator.c interpreter/operators/operator_identity.c interpreter/operators/operator_ternary.c
